...
const skillsData = [
  ...
  { name: "Docker Swarm", categories: ["DevOps"] },
  ...
  { name: "MariaDB", categories: ["Databases"] },
  { name: "SQLite", categories: ["Databases"] },
  { name: "Git", categories: ["Others"] },
  { name: "Vim", categories: ["Others"] },
  { name: "Linux", categories: ["Others"] },
  { name: "Jira", categories: ["Others"] },
  { name: "OOP", categories: ["Others"] },
  { name: "MVC", categories: ["Others"] },
  { name: "DSA", categories: ["Others"] },
  { name: "Selenium", categories: ["Others"] },
  { name: "BeautifulSoup", categories: ["Others"] },
  { name: "openpyxl", categories: ["Others"] },
];
